...
public class AddCustomerDialog extends javax.swing.JDialog {
    ...
    private ICustomerRepository customerRepository; // This should be initialized at some point
    ...
    public void addCustomerOKButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (firstName.isEmpty() || lastName.isEmpty() || phoneNumber.isEmpty()) {
            ...
            BankAccount account = createAccountBasedOnType(accountTypeComboBox.getSelectedItem().toString());
    ...
    private BankAccount createAccountBasedOnType(String type) {
        switch(type) {
            case "Checking": return new CheckingAccount(new BigDecimal(0));
            case "Savings": return new SavingsAccount(new BigDecimal(0));
            case "Investment": return new InvestmentAccount(new BigDecimal(0));
            default: throw new IllegalArgumentException("Invalid account type selected");
        }
    }
