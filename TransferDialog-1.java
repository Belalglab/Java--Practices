...
public class TransferDialog extends javax.swing.JDialog {
    ...
    private void transferOKButtonActionPerformed(ActionEvent evt) {
        BigDecimal amount = new BigDecimal(transferAmountTextField.getText());
        try {
            bankingService.transfer(fromAccount, toAccount, amount);
            JOptionPane.showMessageDialog(this, "Transfer completed successfully!");
        } catch (NoSuchBankAccountException | InsufficientFundException e) {
